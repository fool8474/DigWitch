...
void cameraManager::frameAlphaRender(HDC hdc, image* ig, int destX, int destY, int currentFrameX, int currentFrameY, BYTE alpha)
{
	ig->frameAlphaRender(hdc, getRelativeX(destX), getRelativeY(destY), currentFrameX, currentFrameY, alpha);
}
